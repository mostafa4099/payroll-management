                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown active">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="active"><a href="deletesalary.jsp">Delete Salary Info</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
            ...
            <div class="content col-md-12">
                <div class="row">
                    <div class="panel panel-info">
                        <div class="panel-heading"><h3>Delete Salary Info</h3></div>
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="">
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="id">Employee ID:</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="id" placeholder="Enter Employee ID" ng-model="emp_id">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="id">Transection ID:</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="id" placeholder="Enter Employee ID" ng-model="salary_id">
                                    </div>
                                </div>
                                <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" ng-click="getSalaryBySalID(emp_id, salary_id)">Delete</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-dialog modal-sm">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Are You Sure Delete Transection Id <strong style="color: #c7254e">{{clickSalary.salary_id}}</strong>?</p>
                        </div>
